                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            ...
                            @endif
                            <h4 class="card-header py-2 mt-3">Data Kriteria</h4>
                                ...
                                <table class="table table-hover mt-2">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th class="w-50 text-start">Nama Kriteria</th>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        @foreach ($criterias as $criteria)
                                            <tr>
                                                ...
                                                <td class="text-start">{{ $criteria->nama_kriteria }}</td>
                                                <td class="text-center">{{ $criteria->jenis }}</td>
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        <button type="button"
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                                href="{{ route('kriteria.edit', $criteria->id) }}"><i
                                                                    class="bx bx-edit-alt me-1"></i> Edit</a>
                                                            <form
                                                                action="{{ route('kriteria.destroy', $criteria->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
