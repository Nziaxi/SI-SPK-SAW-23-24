            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <!-- Form -->
                        <div class="col-xl">
                            <h4 class="fw-light">Edit Data Kriteria</h4>
                            <div class="card mb-4">
                                    ...
                                    <form action="{{ route('kriteria.update', $criteria->id) }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama_kriteria"
                                                ...
                                                value="{{ old('nama_kriteria') ?? $criteria->nama_kriteria }}">
                                            @error('nama_kriteria')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="jenis" class="form-select">
                                                <option value="Benefit" @selected('Benefit' == $criteria->jenis)>Benefit</option>
                                                <option value="Cost" @selected('Cost' == $criteria->jenis)>Cost</option>
                                            </select>
                                        </div>
