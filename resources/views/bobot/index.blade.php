                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            ...
                            @endif
                            <h4 class="card-header py-2 mt-3">Data Bobot</h4>
                                ...
                                <table class="table table-hover mt-2">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width=25%>Bobot</th>
                                            <th>Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody class="table-border-bottom-0">
                                        @foreach ($weights as $weight)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $weight->nilai }}</td>
                                                <td>
                                                    <div class="dropdown ps-3">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                                href="{{ route('bobot.edit', $weight->id) }}"><i
                                                                    class="bx bx-edit-alt me-1"></i> Edit</a>
                                                            <form action="{{ route('bobot.destroy', $weight->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
